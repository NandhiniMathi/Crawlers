...
def main():
    try:
        ...
        req = Request('https://www.networkworld.com/index.rss', headers={'User-Agent': 'Mozilla/5.0'} )
        print('open')
        ...
        for item in items:
            ...
            category2 = item.find_all('categories')
            ...
            soup=BeautifulSoup(response.read(),'html.parser')
            description = soup.find_all('section', {'class':'bodee'})
