...
def main():
    try:
        ...
        req = Request('https://api-u.f5.com/support/fedsearch/rss/?q=inmeta:updated_date:2018-05-22..&page=1&results=10&source=kbarticles&source=techcomm&includeArchived=false&excludeFromRecentArticles=true&linkBack=https%3A%2F%2Fsupport.f5.com%2Fcsp%2Fnew-updated-articles', headers={'User-Agent': 'Mozilla/5.0'} )
        print('open')
        ...
        for item in items:
            ...
            soup=BeautifulSoup(response.read(),'html.parser')
            description = soup.find_all('div', {'class':'ng-scope'})
